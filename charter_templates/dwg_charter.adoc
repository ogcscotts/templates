...
This Domain Working Group (DWG) charter defines the role for OGC activities within the <DOMAIN> domain and to provide an open forum for the discussion and presentation of interoperability requirements, use cases, pilots, and implementations of OGC Standards in this domain. This Charter is to be presented to the OGC Technical and Planning Committees for consideration.
