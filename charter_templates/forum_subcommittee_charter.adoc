...
////
The Forum or Subcommittee will need to define key activities it intends on undertaking.  Examples of such activity might be framed around the following considerations.
